...
import { allCourseImages, allAvatars } from '../data.js';
...
const BoxIcon = () => (<svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
  <path strokeLinecap="round" strokeLinejoin="round"
    d="M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" /></svg>);
const PencilIcon = () => (<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
...
function Admin({ onNavigate, onLogout, courses, setCourses }) {
  ...
  const profileImageToShow = currentUser?.profilePicture || userProfileImageDesktop;
  const profileImageMobileToShow = currentUser?.profilePicture || userProfileImageMobile;
  ...
  const handleAddCourse = (e) => {
    ...
    const nextImageIndex = courses.length % allCourseImages.length;
    const newCourse = {
      id: uuidv4(),
      title: title,
      price: price,
      image: allCourseImages[nextImageIndex],
      category: 'Baru',
      subtitle: 'Mulai transformasi dengan instruktur profesional, harga yang terjangkau, dan kurikulum terbaik',
      instructor: {
        name: 'Jenna Ortega', title: 'Senior Accountant di Gojek',
        avatar: allAvatars[nextImageIndex]
      },
      rating: 3.5, ratingCount: 86,
    };
