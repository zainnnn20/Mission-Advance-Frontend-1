...
function Beranda({ onLogout, onNavigate, courses }) {
  ...
  return (
    <div className="beranda-page">
      ...
      <section className="hero-section-wrapper">
        <div className="hero-section" style={{ backgroundImage: `url(${heroBackgroundImage})` }}>
          <div className="hero-content">
            ...
            <p>Temukan ilmu baru yang menarik dan mendalam melalui koleksi video pembelajaran berkualitas tinggi.</p>
      ...
      <section className="cta-section-wrapper">
        <div className="cta-section" style={{ backgroundImage: `url(${ctaBackgroundImage})` }}>
          <div className="cta-content">
            <h2>Mau Belajar Lebih Banyak?</h2>
            <p>Daftarkan dirimu untuk mendapatkan informasi terbaru dari kami.</p>
