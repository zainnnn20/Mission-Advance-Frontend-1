...
function Button({ children, type = 'button', variant = 'primary', onClick }) {
  // Menentukan gaya berdasarkan props 'variant'
  ...
  const styles = {
    ...
    outline: `inline-flex items-center justify-center border border-gray-300 text-gray-700 hover:bg-gray-50 transition-colors ${baseStyle}`,
  };
